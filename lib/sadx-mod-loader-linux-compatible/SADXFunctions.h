...
FunctionPointer(void, AllowFreeCamera, (Bool a1), 0x4348A0);
FunctionPointer(Bool, IsFreeCameraAllowed, (), 0x4348E0);
FunctionPointer(void, EnableFreeCamera, (int a1), 0x4348F0);
FunctionPointer(Bool, IsFreeCameraEnabled, (), 0x434930);
